...
function internal:initBroadcastHooks(tbl)
	...
	--TRUELCH
	tbl.fireSkillTCStartHooks =         self:buildBroadcastFunc("skillTCStartHooks")
	tbl.fireSkillTCEndHooks =           self:buildBroadcastFunc("skillTCEndHooks")
	...
	--TRUELCH
	tbl.fireSkillBuildSecondClickHooks = self:buildBroadcastFunc("skillBuildSecondClickHooks")
