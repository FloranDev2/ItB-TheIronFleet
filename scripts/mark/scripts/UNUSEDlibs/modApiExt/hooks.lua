...
--TRUELCH
hooks.skillTCStartHooks = {}
function hooks:addSkillTCStartHook(fn)
	assert(type(fn) == "function")
	table.insert(self.skillTCStartHooks,fn)
end

--TRUELCH
hooks.skillTCEndHooks = {}
function hooks:addSkillTCEndHook(fn)
	assert(type(fn) == "function")
	table.insert(self.skillTCEndHooks,fn)
end
